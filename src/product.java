...
//        readcsv(RETAILERS_CSV_FILE_PATH,"RETAILER");
        ...
        Retailer[] retailer = new Retailer[LENGTH_OF_PRODUCTS];
            ...
            for (CSVRecord csvRecord : csvParser) {
             ...
             reader = Files.newBufferedReader(Paths.get(file_paths[1]));
            ...
            for (CSVRecord csvRecord : csvParser) {
             ...
             reader = Files.newBufferedReader(Paths.get(file_paths[2]));
             csvParser = new CSVParser(reader, CSVFormat.DEFAULT);
        ...
        while(true)
        {
            ...
            System.out.println( "Select 4 for Take stock for the whosellers" );
